            ...
            <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl">
                <div className="flex items-center justify-between">
                    <div className="text-left">
                        <h3 className="text-2xl font-semibold text-gray-900">Tizimga kirish</h3>
                        <p className="text-sm text-gray-500">Telefon raqamingiz bilan tizimga kiring</p>
                    </div>
                    <button type="button" className="rounded-full bg-gray-100 p-2" onClick={onClose}>
                        <X className="h-4 w-4" />
                    </button>
                </div>
                <div className="mt-6 space-y-4 text-left">
                    {step === 'phone' ? (
                        <>
                            <label className="text-sm font-semibold text-gray-600">Telefon raqam</label>
                            <input
                                type="tel"
                                value={phone}
                        ...
                        <>
                            <div className="rounded-2xl border border-gray-100 bg-gray-50 px-4 py-3 text-sm text-gray-500">
                                ...
                                <p className="text-xs text-gray-400">Ushbu raqamga tasdiqlash kodi yuborildi</p>
                            </div>
                            ...
                            {needsName ? (
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-gray-600">Ismingiz</label>
                                    <input
                                        type="text"
                                        value={fullName}
                    ...
                    {error ? <p className="text-sm text-black500">{error}</p> : null}
                </div>
                <button
                    type="button"
                    disabled={
                    ...
                    className="mt-6 w-full rounded-full bg-black py-3 text-sm font-semibold text-white disabled:bg-gray-300"
                >
